...
st.title('🚚  Daily Driver Work / Drive / Idle Time Analysis')

uploaded_timecard = st.file_uploader('Upload Employee Timecard', type=['xlsx'])
uploaded_tripreport = st.file_uploader(' Upload Trip Report', type=['xlsx'])
